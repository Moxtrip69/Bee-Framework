...
/** @var object{title: string, applicationName: string, apiUrl: string, articleUrlTemplate: string} $d */
...
?>
  <main
    id="articles-crud"
    class="container bee-section main-wrapper"
    data-api-url="<?= $escape($d->apiUrl) ?>"
    data-article-url-template="<?= $escape($d->articleUrlTemplate) ?>"
  >
