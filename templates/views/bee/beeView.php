...
<div class="container py-5">
  <div class="row">
    <div class="col-12 col-md-6 d-flex flex-column justify-content-center">
      ...
      <a href="https://github.com/Moxtrip69/Bee-Framework/tree/1.5.5" class="btn btn-success btn-lg mt-3 col-12 col-sm-6 col-md-6 col-lg-4" target="_blank">
    ...
    <div class="row">
      <div class="col-12 col-md-3">
        <div class="list-group sticky-top" style="top: 25px;" id="scrollSpyDoc">
          ...
          <a href="#prepros" class="list-group-item list-group-item-action">Prepros</a>
          <a href="#db" class="list-group-item list-group-item-action">Base de datos</a>
          <a href="#routing" class="list-group-item list-group-item-action">Routing</a>
          <a href="#modelos" class="list-group-item list-group-item-action">Modelos</a>
          <a href="#coreFunc" class="list-group-item list-group-item-action">Funciones del core</a>
          <a href="#customFunc" class="list-group-item list-group-item-action">Funciones personalizadas</a>
        </div>
      </div>
