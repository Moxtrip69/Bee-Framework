    ...
    <div class="col-12 col-md-6 offset-md-3 py-5">
      <div class="card">
        <div class="card-header d-flex justify-content-between align-items-center">
          <h3 class="m-0"><?php echo $d->title; ?></h3>
          <button class="btn btn-sm btn-success" id="generarNot"><i class="fas fa-plus"></i> Generar</button>
        </div>
        <div class="card-body">
                ...
                <ul class="navbar-nav">
                  <li class="nav-item dropdown">
                    <a class="nav-link position-relative" href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false" id="notWrapper">
                      Notificaciones <i class="fas fa-bell fa-fw"></i>
