...
class clasesController extends Controller implements ControllerInterface {
  ...
  ///////////////////////////////////////////////////////////////////////////////////////////////////////////
  ///////////////////////////////////////////////////////////////////////////////////////////////////////////
  /////////// ASMR Programación - Carga de registros con SSE y Bee framework
  ///////////////////////////////////////////////////////////////////////////////////////////////////////////
  ///////////////////////////////////////////////////////////////////////////////////////////////////////////
  function sse_events()
  {
    register_scripts([JS . 'clases/sse.js'], 'Registros SSE'); // Cargar sólo en esta ruta el archivo
    
    $this->setTitle('Registros con SSE');
    $this->setView('sseRegistros');
    $this->render();
  }
}